...
const Map<String, String> _englishText = {
  ...
  '喝水': 'Water',
  '环境声': 'Ambience',
  '了解这杯': 'About this drink',
  '无酒精': 'Alcohol-free',
  '再来一杯': 'Refill',
  '点杯子喝一口，长按连喝': 'Tap to sip, hold to keep sipping',
  '点杯子喝一口 · 长按连喝 · 点书本看配方': 'Tap to sip · Hold to sip again · Open the recipe',
  '已喝完，点杯子或“再来一杯”续杯': 'Empty glass. Tap it or refill.',
  '搜索饮品': 'Search drinks',
  '没有找到饮品': 'No drinks found',
  '适合这杯饮品': 'Recommended for this drink',
  '播放场景环境声': 'Play scene ambience',
  '配方用料': 'Ingredients',
  '风味与结构': 'Flavor and balance',
  '背景故事': 'Story',
  '制作技法': 'Technique',
  '在家替代': 'At-home alternatives',
  '首页': 'Home',
  '地图': 'Map',
  '我的': 'Profile',
  '消息': 'Messages',
  ...
  '资料审核未通过': 'Profile rejected',
  '资料审核状态': 'Profile review status',
  '昵称、头像或简介的修改正在审核中。': 'Changes to your name, avatar, or bio are under review.',
  '原因': 'Reason',
  '暂无消息': 'No messages yet',
  '部分消息加载失败': 'Some messages could not be loaded',
  '隐私设置': 'Privacy',
  '夸一下': 'Like Us',
  ...
  '地图工具': 'Map Tools',
  '筛选': 'Filters',
  '暂无符合筛选条件的酒吧': 'No bars match these filters',
  '试着调整金额、评分或酒吧类型': 'Adjust the price, rating, or bar type',
